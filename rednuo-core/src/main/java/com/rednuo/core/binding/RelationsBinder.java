...
import com.rednuo.core.binding.annotation.*;
import com.rednuo.core.binding.binder.*;
import com.rednuo.core.binding.helper.DeepRelationsBinder;
import com.rednuo.core.binding.parser.BindAnnotationGroup;
import com.rednuo.core.binding.parser.ConditionManager;
import com.rednuo.core.binding.parser.FieldAnnotation;
...
import com.rednuo.core.service.DictionaryServiceExtProvider;
...
public class RelationsBinder {
    ...
    private static <VO> void doBindingDict(List<VO> voList, FieldAnnotation fieldAnno) {
        ...
        if(bindDictService != null){
            ...
            ExceptionCast.cast(CoreCode.FAIL, "BindDictService未实现，无法使用BindDict注解！");
        }
    }
