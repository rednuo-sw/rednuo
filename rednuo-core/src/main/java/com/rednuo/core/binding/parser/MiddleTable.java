...
import com.rednuo.core.binding.binder.BaseBinder;
...
import com.rednuo.core.utils.SqlExecutor;
...
public class MiddleTable {
    ...
    public MiddleTable connectBranchObj(String middleTableCol, String branchObjCol){
        if(branchObjColMapping == null){
            ...
            ExceptionCast.cast(CoreCode.FAIL, BaseBinder.NOT_SUPPORT_MSG);
        }
