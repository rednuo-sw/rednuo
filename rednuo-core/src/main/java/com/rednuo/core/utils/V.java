...
public class V {
	...
	public static boolean starMatchers(String source, String... regexPatterns){
		String[] var4 = regexPatterns;
		int var5 = regexPatterns.length;
		...
		for(int var6 =0; var6<var5; ++var6){
			...
			if("/**".equals(pattern)|| "**".equals(pattern)) {
				return true;
			} else if(path.match(var4[var6], source)){
				return true;
			}
...
//				String substring = pattern.substring(0, pattern.length() - 3);
//
//			}
		}
		return false;
